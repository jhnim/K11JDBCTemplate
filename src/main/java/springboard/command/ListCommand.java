...
public class ListCommand implements BbsCommandImpl{
	...
	public void execute(Model model) {
		...
		/*
		 컨트롤러에서 인자로 전달한 model객체에서는 request객체가 저장되어있다.
...
///////////////////////// 페이지처리 end ////////////////////
		...
		String pagingImg = PagingUtil.pagingImg(totalRecordCount, pageSize, blockPage, 
				nowPage, req.getContextPath()+"/board/list.do?"+addQueryString);
